    ...
    <footer className='max-container'>
      ...
      flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          font-montserrat text-white-400 sm:max-w-sm'>Get shoes ready for the new term at your nearest Nike store. 
      ...
      mt-24 max-sm:flex-col max-sm:items-center'>
          ...
          justify-start items-center gap-2 font-montserrat cursor-pointer'>
            <img 
              src={copyrightSign}
              alt='copy right sign'
              width={20}
